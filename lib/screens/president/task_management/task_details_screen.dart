...
import 'package:flutter_cache_manager/flutter_cache_manager.dart';
import 'package:url_launcher/url_launcher.dart';
// Removed the gallery_saver import
// import 'package:gallery_saver/gallery_saver.dart';
import 'package:permission_handler/permission_handler.dart';
...
class TaskDetailsScreen extends StatelessWidget {
  ...
  // Method to download and save the image locally without using gallery_saver
  Future<void> _downloadImage(dynamic imagePath, BuildContext context) async {
    if (imagePath == null) {
      print("No image available to download.");
      return;
    ...
    try {
      ...
      if (path != null) {
        ...
        // Removed the gallery saving part
        // You can add other functionalities here, like notifying the user the image was saved locally
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text("Image downloaded locally."),
            backgroundColor: Colors.green,
          ),
        );
      }
