...
class ContentTeamLeaderPerformanceScreen extends StatefulWidget {
  @override
  _ContentTeamLeaderPerformanceScreenState createState() =>
      _ContentTeamLeaderPerformanceScreenState();
}

class _ContentTeamLeaderPerformanceScreenState
    extends State<ContentTeamLeaderPerformanceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Content Team Performance"),
      ),
      body: Column(
        children: [
          Padding(
